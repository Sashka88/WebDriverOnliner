...
public class TvPage extends AbstractPage {
  ...
  public TvPage writeTvPrice() {
    driver.findElement(priceFieldXpath).sendKeys(onlinerTvData.getTestData("testdata.price"));
    new WebDriverWait(driver, WAIT_TIMEOUT_SECONDS)
        .ignoring(NoSuchElementException.class)
        .until(ExpectedConditions.invisibilityOfElementLocated(animationXpath));
    return this;
  ...
  public TvPage selectTvDiagonal() {
    driver
        ...
        .sendKeys(onlinerTvData.getTestData("testdata.mindiagonal"));
    driver
        .findElement(maxDiagonalFieldXpath)
        .sendKeys(onlinerTvData.getTestData("testdata.maxdiagonal"));
    new WebDriverWait(driver, WAIT_TIMEOUT_SECONDS)
        .ignoring(NoSuchElementException.class)
        .until(ExpectedConditions.invisibilityOfElementLocated(animationXpath));
    return this;
  ...
  public TvPage vailidateDiagonal() {
    ...
    for (WebElement productDescription : productDescriptions) {
      ...
      int minDiagonal = Integer.parseInt(onlinerTvData.getTestData("testdata.mindiagonal"));
      int maxDiagonal = Integer.parseInt(onlinerTvData.getTestData("testdata.maxdiagonal"));
      softAssert.assertTrue(
